...
@section('title', 'Daftar Tingkat | MFIN')

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Daftar Tingkat</h1>
    </div>
        ...
        <div class="col-lg-9 mb-4">
            <div class="card">
                <div class="card-header bg-body-tertiary">
                    <form id="filter-form" action="{{ $data_form->id ? route('cgrade.edit', $data_form->id) : route('cgrade.index') }}" method="GET">
                        <div class="input-group input-group-sm" style="max-width: 300px;">
                            <input type="text" id="search-input" class="form-control" name="search" placeholder="Filter Tingkat..." value="{{ $searchTerm ?? '' }}">
                ...
                <div id="table-container">
                    @include('admin.cgrade._cgrade_table', ['list_data' => $list_data])
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ $form_action }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <label for="title" class="form-label">Nama Tingkat *</label>
                        ...
                        <div class="d-grid gap-2">
                            @if ($data_form->id)
                                ...
                                <a href="{{ route('cgrade.index') }}" class="btn btn-secondary btn-sm"> Batal</a>
                            @else
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchInput.addEventListener('keyup', function () {
            ...
            debounceTimer = setTimeout(function () {
                ...
                const baseUrl = "{{ route('cgrade.index') }}";
