...
@section('title', 'Daftar Jurusan | MFIN')
...
@section('content')
    ...
    {{-- Tata Letak Grid Berdampingan (Sesuai permintaan Anda) --}}
    <div class="row">
        ...
        <div class="col-lg-9 mb-4">
            <div class="card">
                <div class="card-header bg-body-tertiary">
                    <form id="filter-form" action="{{ $data_form->id ? route('csubject.edit', $data_form->id) : route('csubject.index') }}" method="GET">
                        <div class="input-group input-group-sm" style="max-width: 300px;">
                            <input type="text" id="search-input" class="form-control" name="search" placeholder="Filter Jurusan..." value="{{ $searchTerm ?? '' }}">
                ...
                <div id="table-container">
                    @include('admin.csubject._csubject_table', ['list_data' => $list_data])
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ $form_action }}" method="POST">
                        ...
                        <div class="d-grid gap-2">
                            @if ($data_form->id)
                                ...
                                <a href="{{ route('csubject.index') }}" class="btn btn-secondary btn-sm"> Batal</a>
                            @else
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchInput.addEventListener('keyup', function () {
            ...
            debounceTimer = setTimeout(function () {
                ...
                const baseUrl = "{{ route('csubject.index') }}";
