...
@section('title', 'Edit Siswa | MFIN')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Data Siswa: <strong class="text-primary">{{ $student->fullname }}</strong></h1>
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('student.update', $student->id) }}" method="POST" id="student-form">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="fullname" name="fullname" class="form-control @error('fullname') is-invalid @enderror" value="{{ old('fullname', $student->fullname) }}" required>
                        @error('fullname') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label for="nickname" class="form-label">Nama Panggilan</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="nickname" name="nickname" class="form-control" value="{{ old('nickname', $student->nickname) }}">
                    </div>
                    <div class="mb-3">
                        <label for="placeofbirth" class="form-label">Tempat Lahir</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="placeofbirth" name="placeofbirth" class="form-control" value="{{ old('placeofbirth', $student->placeofbirth) }}">
                    </div>
                    <div class="mb-3">
                        <label for="dateofbirth" class="form-label">Tanggal Lahir</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="date" id="dateofbirth" name="dateofbirth" class="form-control" value="{{ old('dateofbirth', $student->dateofbirth) }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- [PERUBAHAN] Menambahkan value di textarea --}}
                        <textarea id="street" name="street" class="form-control">{{ old('street', $student->street) }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="province" name="province" class="form-control" value="{{ old('province', $student->province) }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="postalcode" name="postalcode" class="form-control" value="{{ old('postalcode', $student->postalcode) }}">
                    </div>
                    <div class="mb-3">
                        <label for="home_phone" class="form-label">Telepon Rumah</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="home_phone" name="home_phone" class="form-control" value="{{ old('home_phone', $student->home_phone) }}">
                    </div>
                    <div class="mb-3">
                        <label for="mobile_phone" class="form-label">HP</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="mobile_phone" name="mobile_phone" class="form-control" value="{{ old('mobile_phone', $student->mobile_phone) }}">
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $student->email) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="is_active" name="is_active" class="form-select">
                            <option value="yes" {{ old('is_active', $student->is_active) == 'yes' ? 'selected' : '' }}>Yes</option>
                            <option value="no" {{ old('is_active', $student->is_active) == 'no' ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                {{-- [PERUBAHAN] Menambahkan value --}}
                                <input type="number" id="height" name="height" class="form-control" value="{{ old('height', $student->height) }}">
                            </div>
                            <div class="mb-3">
                                <label for="cronic_desease" class="form-label">Penyakit Kronis</label>
                                {{-- [PERUBAHAN] Menambahkan value --}}
                                <input type="text" id="cronic_desease" name="cronic_desease" class="form-control" value="{{ old('cronic_desease', $student->cronic_desease) }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                {{-- [PERUBAHAN] Menambahkan value --}}
                                <input type="number" id="weight" name="weight" class="form-control" value="{{ old('weight', $student->weight) }}">
                            </div>
                            <div class="mb-3">
                                <label for="severe_desease" class="form-label">Penyakit Berat yg Pernah Diderita</label>
                                {{-- [PERUBAHAN] Menambahkan value di textarea --}}
                                <textarea id="severe_desease" name="severe_desease" class="form-control">{{ old('severe_desease', $student->severe_desease) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>

                {{-- Kolom Kanan: Data Lainnya (Kesiswaan & Ortu) --}}
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="nin" name="nin" class="form-control @error('nin') is-invalid @enderror" value="{{ old('nin', $student->nin) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="father_id" name="father_id" class="form-select @error('father_id') is-invalid @enderror">
                            ...
                            @foreach ($parents as $parent)
                                {{-- [PERUBAHAN] Menambahkan logic 'selected' --}}
                                <option value="{{ $parent->id }}" {{ old('father_id', $student->father_id) == $parent->id ? 'selected' : '' }}>{{ $parent->fullname }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="mother_id" name="mother_id" class="form-select @error('mother_id') is-invalid @enderror">
                            ...
                            @foreach ($parents as $parent)
                                {{-- [PERUBAHAN] Menambahkan logic 'selected' --}}
                                <option value="{{ $parent->id }}" {{ old('mother_id', $student->mother_id) == $parent->id ? 'selected' : '' }}>{{ $parent->fullname }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="parent_id" name="parent_id" class="form-select @error('parent_id') is-invalid @enderror">
                            ...
                            @foreach ($parents as $parent)
                                {{-- [PERUBAHAN] Menambahkan logic 'selected' --}}
                                <option value="{{ $parent->id }}" {{ old('parent_id', $student->parent_id) == $parent->id ? 'selected' : '' }}>{{ $parent->fullname }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="parent_relation" name="parent_relation" class="form-control" value="{{ old('parent_relation', $student->parent_relation) }}">
                    </div>
                    <div class="mb-3">
                        <label for="live_with" class="form-label">Tinggal Dengan</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="live_with" name="live_with" class="form-control" value="{{ old('live_with', $student->live_with) }}">
                    </div>
                    <div class="mb-3">
                        <label for="mothertongue" class="form-label">Bahasa Ibu</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="text" id="mothertongue" name="mothertongue" class="form-control" value="{{ old('mothertongue', $student->mothertongue) }}">
                    </div>
                    <div class="mb-3">
                        <label for="birthorder" class="form-label">Anak Ke-</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="number" id="birthorder" name="birthorder" class="form-control" value="{{ old('birthorder', $student->birthorder) }}">
                    </div>
                    <div class="mb-3">
                        <label for="total_sibling" class="form-label">Jml Saudara Kandung</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="number" id="total_sibling" name="total_sibling" class="form-control" value="{{ old('total_sibling', $student->total_sibling) }}">
                    </div>
                    <div class="mb-3">
                        <label for="total_stepbrother" class="form-label">Jml Saudara Tiri</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="number" id="total_stepbrother" name="total_stepbrother" class="form-control" value="{{ old('total_stepbrother', $student->total_stepbrother) }}">
                    </div>
                    <div class="mb-3">
                        <label for="total_fosterbrother" class="form-label">Jml Saudara Angkat</label>
                        {{-- [PERUBAHAN] Menambahkan value --}}
                        <input type="number" id="total_fosterbrother" name="total_fosterbrother" class="form-control" value="{{ old('total_fosterbrother', $student->total_fosterbrother) }}">
                    </div>
                    
                    {{-- [PERUBAHAN] Radio Button Jarak ke Sekolah --}}
                    <div class="mb-3">
                        <label class="form-label d-block">Jarak ke Sekolah</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="distancetoschool1" id="dist1" value="<1 km" 
                                {{ old('distancetoschool1', $student->distancetoschool1) == '<1 km' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="distancetoschool1" id="dist2" value="1-5 km"
                                {{ old('distancetoschool1', $student->distancetoschool1) == '1-5 km' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="distancetoschool1" id="dist3" value="> 5km"
                                {{ old('distancetoschool1', $student->distancetoschool1) == '> 5km' ? 'checked' : '' }}>
                            <label class="form-check-label" for="dist3">&gt; 5km</label>
                        </div>
                        <div class="d-flex align-items-center mt-2">
                            <div class="form-check" style="flex-shrink: 0;">
                                <input class="form-check-input" type="radio" name="distancetoschool1" id="dist_other" value="other"
                                    {{ old('distancetoschool1', $student->distancetoschool1) == 'other' ? 'checked' : '' }}>
                            ...
                            <input type="text" name="distancetoschool2" class="form-control form-control-sm ms-2" style="max-width: 200px;" 
                                value="{{ old('distancetoschool2', $student->distancetoschool2) }}">
                        </div>
                    </div>
                    
                    {{-- [PERUBAHAN] Radio Button Pergi ke sekolah --}}
                    <div class="mb-3">
                        <label class="form-label d-block">Pergi ke sekolah</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gotoschool_with1" id="goto1" value="antar jemput orang tua" 
                                {{ old('gotoschool_with1', $student->gotoschool_with1) == 'antar jemput orang tua' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gotoschool_with1" id="goto2" value="antar jemput langganan"
                                {{ old('gotoschool_with1', $student->gotoschool_with1) == 'antar jemput langganan' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gotoschool_with1" id="goto3" value="sendiri"
                                {{ old('gotoschool_with1', $student->gotoschool_with1) == 'sendiri' ? 'checked' : '' }}>
                        ...
                        <div class="d-flex align-items-center mt-2">
                            <div class="form-check" style="flex-shrink: 0;">
                                <input class="form-check-input" type="radio" name="gotoschool_with1" id="goto_other" value="other"
                                    {{ old('gotoschool_with1', $student->gotoschool_with1) == 'other' ? 'checked' : '' }}>
                            ...
                            <input type="text" name="gotoschool_with2" class="form-control form-control-sm ms-2" style="max-width: 200px;"
                                value="{{ old('gotoschool_with2', $student->gotoschool_with2) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-end mt-4">
                ...
                <button type="submit" id="save-button" class="btn btn-primary">
                    <i class="bi bi-check-circle me-1"></i> Perbarui Data Siswa
                </button>
        ...
        document.querySelectorAll('input, select').forEach(function(input) {
            input.addEventListener('input', function() {
                if (this.classList.contains('is-invalid')) {
                    if (this.id === 'nis') {
                        let errorFeedback = this.closest('.mb-3').querySelector('.invalid-demand');
