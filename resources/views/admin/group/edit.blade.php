        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.group.update', $group->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('ordering') is-invalid @enderror" id="ordering" name="ordering" value="{{ old('ordering', $group->ordering) }}" required>
