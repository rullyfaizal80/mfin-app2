...
<body>
    ...
    {{-- LOGIKA UNTUK MENGAMBIL NAMA KASIR --}}
    @php
        $cashierName = 'Semua Kasir';
        $cas_id = request()->segment(4); // Mengambil ID kasir dari URL parameter ke-4
        if($cas_id && $cas_id != '0') {
            $kasir = \Illuminate\Support\Facades\DB::table('sis_user')->where('id', $cas_id)->first();
            if($kasir) {
                $cashierName = $kasir->fullname;
            }
        }
    @endphp
    ...
    <div class="report-container">
        ...
        <table class="table-data">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" align="center" style="padding: 20px;">Tidak ada data transaksi pemasukan pada periode ini.</td>
                    </tr>
                @endforelse
