...
<div class="container-fluid py-4 d-flex justify-content-center">
    <div class="card shadow-sm border-0" style="max-width: 450px; width: 100%;">
        ...
        <div class="card-body p-4">
            ...
            <!-- Form menuju route proses unlock pembayaran -->
            <form action="{{ route('fincom.payment.unlock.process', $id) }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    ...
                    <!-- Batal kembali ke index pembayaran -->
                    <a href="{{ route('fincom.payment.index') }}" class="btn btn-outline-secondary">Batal & Kembali</a>
                </div>
            </form>
        </div>
    </div>
